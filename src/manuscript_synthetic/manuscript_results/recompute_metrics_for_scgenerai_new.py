...
if __name__== '__main__':
    ...
    outdir = f'/data_nfs/og86asub/netmap/netmap-evaluation/results/summaries_scgenerai_new/{net}'
    grn_path = f"/data_nfs/og86asub/netmap/netmap-evaluation/results/scgenerai/config_easy/nodesc/{net}/scgenerai.h5ad"
    ...
    aggregated_performance = compute_metrics.compute_aggregated_grn_result(grn_adata2, forward_reverse_nets, cluster_col = 'spectral_remap' )
