...
from src.manuscript_synthetic.data_generation.utils import write_config,  PipelineConfig
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config_file", type=str, help="dataset id", required=True)
