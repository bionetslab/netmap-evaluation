...
if __name__== '__main__':
    ...
    outdir = f'/data_nfs/og86asub/netmap/netmap-evaluation/results/summaries_best_models/{net}'
    ...
    for hd in hyper.keys():   
        for dp in dropout_percentage:
            for mt in model_type:
                ...
                for xai in ['GuidedBackprop', 'GradientShap']:
                    ...
                    for bg in bg_modes:
                        ...
                        for raw in attribution_raw:
                            ...
                            grn_adata2 = inferrence.inferrence(model_zoo, data_tensor.cuda(), gene_names, xai_method=xai, background_type = 'zeros', raw=raw)
                            ...
                            aggregated_performance_scaled.to_csv(op.join(outdir, f'{xai}_{hd}_{dp}_{mt}_{bg}_{raw}_aggregated_performance_scaled.tsv'), sep = '\t')
