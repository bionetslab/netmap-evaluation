...
def train_model(adata, output_dir, model_name, scale = 'norm'):
...
if __name__=='__main__':
    ...
    model_name = 'blood-10x-rep1-cellbender-norm'
    model_output_dir = op.join(output_dir, model_name)
    os.makedirs(model_output_dir, exist_ok=True)
    adata = sc.read_h5ad('/data_nfs/og86asub/netmap/netmap-evaluation/netmap/data/blood/reprocessed/blood-10x-rep1-cellbender.h5ad')
    train_model(adata, output_dir=model_output_dir, model_name = model_name, scale = 'norm')

    model_name = 'blood-10x-rep1-cellbender-X'
    model_output_dir = op.join(output_dir, model_name)
    os.makedirs(model_output_dir, exist_ok=True)
    adata = sc.read_h5ad('/data_nfs/og86asub/netmap/netmap-evaluation/netmap/data/blood/reprocessed/blood-10x-rep1-cellbender.h5ad')
    train_model(adata, output_dir=model_output_dir, model_name = model_name, scale = 'X')

    model_name = 'blood-10x-rep1-cellbender-count'
    model_output_dir = op.join(output_dir, model_name)
    os.makedirs(model_output_dir, exist_ok=True)
    adata = sc.read_h5ad('/data_nfs/og86asub/netmap/netmap-evaluation/netmap/data/blood/reprocessed/blood-10x-rep1-cellbender.h5ad')
    train_model(adata, output_dir=model_output_dir, model_name = model_name, scale = 'count')

    model_name = 'blood-10x-rep1-cellbender-norm-wk'
    model_output_dir = op.join(output_dir, model_name)
    os.makedirs(model_output_dir, exist_ok=True)
    adata = sc.read_h5ad('/data_nfs/og86asub/netmap/netmap-evaluation/netmap/data/blood/reprocessed/blood-10x-rep1-cellbender-wk.h5ad')
    train_model(adata, output_dir=model_output_dir, model_name = model_name, scale = 'norm')

    model_name = 'blood-10x-rep1-cellbender-X-wk'
    model_output_dir = op.join(output_dir, model_name)
    os.makedirs(model_output_dir, exist_ok=True)
    adata = sc.read_h5ad('/data_nfs/og86asub/netmap/netmap-evaluation/netmap/data/blood/reprocessed/blood-10x-rep1-cellbender-wk.h5ad')
    train_model(adata, output_dir=model_output_dir, model_name = model_name, scale = 'X')

    model_name = 'blood-10x-rep1-cellbender-count-wl'
    model_output_dir = op.join(output_dir, model_name)
    os.makedirs(model_output_dir, exist_ok=True)
    adata = sc.read_h5ad('/data_nfs/og86asub/netmap/netmap-evaluation/netmap/data/blood/reprocessed/blood-10x-rep1-cellbender-wk.h5ad')
    train_model(adata, output_dir=model_output_dir, model_name = model_name, scale = 'count')
